...
const APP_BUILD_ID = String((typeof __APP_BUILD_ID__ !== 'undefined' ? __APP_BUILD_ID__ : '') || 'build-v1.0.4');
                ...
                <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-sm text-slate-400">Loading...</div>}>
                    <Routes location={location} key={location.pathname}>
                        ...
                        <Route element={<ProtectedRoute><Layout /></ProtectedRoute>}>
                            ...
                            <Route path="/jurnal-rute" element={<ProtectedRoute allowedRoles={['Admin', 'Manager', 'Dispatcher']}><GlobalRouteHistory /></ProtectedRoute>} />
