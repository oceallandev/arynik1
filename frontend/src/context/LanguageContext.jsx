...
const STRINGS = {
    en: {
        ...
        'menu.bib': 'BIB',
        'menu.bib_desc': 'Buy-back stats',
        'menu.notifications': 'Notifications',
        'menu.notifications_desc': 'Allocation updates',
        'menu.chat': 'Chat',
        'menu.chat_desc': 'Recipient messaging',
        'menu.assistant': 'Virtual Assistant',
        'menu.assistant_desc': 'AI help for app workflows',
        ...
        'menu.manual': 'Usage Manual',
        'menu.manual_desc': 'How to use the app',
    ...
    ro: {
        ...
        'menu.bib': 'BIB',
        'menu.bib_desc': 'Statistici buy-back',
        'menu.notifications': 'Notificari',
        'menu.notifications_desc': 'Actualizari alocari',
        'menu.chat': 'Chat',
        'menu.chat_desc': 'Mesaje destinatar',
        'menu.assistant': 'Asistent virtual',
        'menu.assistant_desc': 'Ajutor AI pentru fluxurile din aplicatie',
        ...
        'menu.manual': 'Manual utilizare',
        'menu.manual_desc': 'Cum se foloseste aplicatia',
