    ...
    return (
        <div className="min-h-screen flex flex-col relative overflow-hidden">
            ...
            <header className="px-6 py-5 flex justify-between items-center sticky top-0 z-30 glass-strong rounded-b-[32px] mx-2 mt-2 shadow-lg border-iridescent animate-slide-down">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-400 font-medium mt-1">Daily view + relevant stats</p>
                    </div>
                </div>
            ...
            <div className="flex-1 p-4 pb-32 space-y-6 relative z-10">
                ...
                <div className="glass-strong p-5 rounded-2xl border-iridescent space-y-3 animate-scale-in">
                    <div className="flex items-center justify-between gap-3">
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Selected day</p>
                            <p className="text-lg font-black text-white">
                                {selectedStats?.day
                                    ? new Date(currentDate.getFullYear(), currentDate.getMonth(), Number(selectedStats.day)).toLocaleDateString()
                                    : '--'}
                            </p>
                        </div>
                        <button
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <div className="rounded-xl border border-emerald-400/25 bg-emerald-500/10 p-3">
                            <p className="text-[10px] font-black text-emerald-200 uppercase tracking-wider">Delivered</p>
                        ...
                        <div className="rounded-xl border border-violet-400/25 bg-violet-500/10 p-3">
                            <p className="text-[10px] font-black text-violet-200 uppercase tracking-wider">Payment</p>
